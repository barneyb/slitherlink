...
class SolverTest {
    ...
    fun medium20x20v1b11p4() {
        ...
        assertPartialSolve(
            726,
            krazydad("...132...12..31...3.22..3....2..12...121..31..32323...123..3...22..2....2.222.23.3331...3...21...22.....0.222.3.3..3.....2332.3.....2..22.3..2.2....2223...3....1..3.2..2...021.32.21...3..22....3...2..2..2...2.231.2......22..2.2.2.3.3.2..1223.....1.23...2.333...2.2....1.2.332..2..22.2.....23..0..33.3213.1..1.0....3...2.3..133.3..32...31.....3.12..2.3..3.2232.112.2.2...3....21.3..2..2...3...33..21..")
        )
    }
    ...
    fun hard7x7v1b1p2() {
        ...
        assertSolve(krazydad(".1.322...31..13.3.3........33...21..312..21...3.3"))
    }
    ...
    fun hard10x10v1b24p6() {
        assertPartialSolve(174, krazydad(
            """
                1.2...221.
                .22.221.2.
                322.2..2.2
    ...
    fun hard20x20v1b1p1() {
        ...
        assertPartialSolve(
            782,
            krazydad("2....2.2.1.2.22.33....2.3...3.32....1.1212..223..2...22.32..1.2..2..22.......22.2..1...33....213.1..1..22...13....31.3...32.....2..32..10..33.3..21..3...3.23.2.2..2.2.1..1....2.1....2..22331..33..2...213..2...2.....3..32....3...11.2..0.1..3..3.232..32...2.2.2..3.2.2.232.3.....2.3.3...12..2.....123..2.2..21....33.2.3.02..3...3.2.2..2.2..2..1.....2..0.21.2......1.3121..232.3..2..3.21....22...22..32.")
        )
    }
...
private fun assertSolve(p: Puzzle): SolveState {
    val stats = run(p)
    if (!stats.solved) {
        printPuzzleAndStats(stats)
    ...
    val maxMoves =
        p.humanRows * (p.humanCols + 1) + (p.humanRows + 1) * p.humanCols
