...
class SolverTest {
    ...
    fun medium7x7() {
        ...
        assertSolve(krazydad("33.3222.12.2...2...12202.2....3...3.1.12.113....2"))
        // KD_Slitherlink_7x7_d1_V1-B1-P2 : D9E53C293DC94B4763266AA8277E
        assertSolve(krazydad("3..3.31......2.0323..3..13....212.3.....1.13.322."))
    ...
    fun medium20x20() {
        ...
        assertPartialSolve(493, krazydad(".3..3..223..2...33....2130....0...0.12.22.312.32..22..2....22...2.2.2.22.20..2..3..1..2..230..2..12.....3222.2..2...32231.2.3......21..2...3..3.....31..3.321...2203213..22...11.3....2...3..30232..2022.1..22..2..21...32.....3.2........33...12.2....1.2....1.1.1.2..22333313.3..2..3.2.....1.1....2.3.2.3....2..3..2.2...1....3..2.221.1.222..1.2322.......3.1.122.3....233.32.1233.3..1.3...1...23.1...1..31"))
    ...
    fun hard20x20() {
        ...
        assertPartialSolve(410, krazydad("2....2.2.1.2.22.33....2.3...3.32....1.1212..223..2...22.32..1.2..2..22.......22.2..1...33....213.1..1..22...13....31.3...32.....2..32..10..33.3..21..3...3.23.2.2..2.2.1..1....2.1....2..22331..33..2...213..2...2.....3..32....3...11.2..0.1..3..3.232..32...2.2.2..3.2.2.232.3.....2.3.3...12..2.....123..2.2..21....33.2.3.02..3...3.2.2..2.2..2..1.....2..0.21.2......1.3121..232.3..2..3.21....22...22..32."))
    }

    fun assertPartialSolve(moves: Int, p: Puzzle) {
        val stats = run(p)
        if (stats.moveCount != moves) {
            throw AssertionError("expected $moves moves to be made, but ${stats.moveCount} were")
        }
    }
